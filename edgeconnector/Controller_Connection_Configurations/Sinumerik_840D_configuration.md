...
The Softing product **NETLink S7-Compact** supports the PG/MPI to Ethernet conversion and thus is a
...
address `30` is not used and thus can be assigned to **NETLink S7-Compact**.
...
|                      | The interface is recommended for connecting **NETLink S7-Compact**. It requires its own 24 V power supply, since the connector X122 does not provide any voltage. |
|                      | If a connector is already connected here, **NETLink S7-Compact** can be plugged on top or in between.        |
| X101                 | It is used for connecting the control panel/operating panel (control panel interface) and is not recommended for the communication via **NETLink S7-Compact**.    |

# Configure NETLink S7-Compact

The **NETLink S7-Compact** configuration is performed in the appropriate configuration page (see the figure below).

The important **NETLink S7-Compact** settings include:

| Variable                  | Description                                                                                                   |
| ------------------------- | ------------------------------------------------------------------------------------------------------------- |
| IP Address                | Address for reaching **NETLink S7-Compact**.                                                                 |
...
| Own Station Address       | MPI address of **NETLink S7-Compact**.                                                                       |
...
![Configuration NETLink S7-Compact](../../documentation_pics/config_echolinkS7.png)
...
- **IPv4 Address** must correspond to the IP address of **NETLink S7-Compact** (here: 192.168.1.15).
...
**dataFEED edgeConnector**, as described above.